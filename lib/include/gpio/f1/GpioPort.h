...
namespace stm32plus {
  ...
  namespace gpioHelper {
    ...
    template<> inline uint32_t getPeripheral<GPIOA_BASE>() { return RCC_APB2Periph_GPIOA; }
    template<> inline uint32_t getPeripheral<GPIOB_BASE>() { return RCC_APB2Periph_GPIOB; }
